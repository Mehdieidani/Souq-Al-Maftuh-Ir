...
async function sendMainMenu(chatId, token, host) {
    const keyboard = {
        keyboard: [
            ...
            [{ text: "🛍 ورود به بازار (مینی‌اپ)", web_app: { url: `https://${host}` } }],
            [{ text: "☎️ پشتیبانی" }, { text: "⭐ خرید اشتراک ویژه" }]
        ],
        resize_keyboard: true
    };
    await sendMessage(chatId, "👋 سلام! به **بازار بزرگ بین‌المللی** خوش آمدید.\nلطفا گزینه مورد نظر خود را انتخاب کنید:", token, keyboard);
}
